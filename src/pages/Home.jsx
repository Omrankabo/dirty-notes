  ...
  return (
    <main>
      <div className="flex flex-col md:items-center justify-center gap-2 my-8 h-[75vh] md:max-w-[584px] mx-auto  ">
        <h1 class="sm:text-6xl md:text-7xl text-5xl mb-2 font-medium md:text-center uppercase ">
          Get some Magical <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-base to-secondary-base">
            Notes
          </span> to study better!. 
